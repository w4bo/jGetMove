...
public class Debug {
    ...
    public static void print(Object o) {
        if (debug)
            System.out.print(stack.concat(" ").concat(o.toString()));
    }
    ...
    public static void println(Object o) {
        if (debug)
            System.out.println(stack.concat(" ").concat(o.toString()));
    }
    ...
    public static void err(Object o) {
        if (debug)
            System.err.print(stack.concat(" ").concat(o.toString()));
    }
    ...
    public static void errln(Object o) {
        if (debug)
            System.err.println(stack.concat(" ").concat(o.toString()));
